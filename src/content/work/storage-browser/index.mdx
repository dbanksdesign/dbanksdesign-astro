...
import { StorageBrowserDemo } from '@components/Amplify';
...
<center>
_☝️ This is a live demo, with a live S3 bucket!_
</center>
...
<YouTubeFigure id="UBpX8hCpLAY" />

## Demos

I created these demo videos for this re:Invent session:

<YouTubeFigure id="YZVbSUHHZ5k" title="Live coding on the AWS Live stream" />

And live coded them on the AWS Live stream:

<YouTubeFigure id="o54A_jliO8s" title="Live coding on the AWS Live stream" />


<Video src={Demo1} caption="Setting up the Storage Browser" />

<Video src={Demo2} caption="Styling the Storage Browser" />

<Video src={Demo3} caption="Using a custom layout" />

<Video src={Demo4} caption="Using a custom dialog component" />

<Video src={Demo5} caption="Adding a custom share action" />

<Video src={Demo6} caption="Adding a custom view for the share action" />
