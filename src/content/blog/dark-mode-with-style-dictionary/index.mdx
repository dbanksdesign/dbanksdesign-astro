...
description: 'Dark mode is so hot right now. This article goes in depth into how dark mode works on Android, iOS, and the web as well as tips on how to structure your design tokens and 2 different implementations of dark mode in Style Dictionary.'
---

import { Image } from 'astro:assets';
import FileTree from '@components/FileTree.astro'
import ThemedImage from '@components/ThemedImage.astro';
import preview from 'images/preview.mp4';
import ASProjectDark from 'images/as-project-dark.png'
import ASProjectLight from 'images/as-project-light.png'
import ASAndroidLight from 'images/as-android-light.png'
import ASAndroidDark from 'images/as-android-dark.png'
import iOSAssetLight from 'images/ios-asset-light.png'
import iOSAssetDark from 'images/ios-asset-dark.png'
import ColorsetLight from 'images/colorset-light.png'
import ColorsetDark from 'images/colorset-dark.png'
import HighContrastLight from 'images/ios-hc-light.png'
import HighContrastDark from 'images/ios-hc-dark.png'
...
<ThemedImage
  light={ASProjectLight}
  dark={ASProjectDark}
  style={{width: '48%', float: 'left'}}
  alt="Project view shows actual folder structure" />

<ThemedImage
  light={ASAndroidLight}
  dark={ASAndroidDark}
  style={{width: '48%', float: 'right'}}
  alt="Android view organizes files to reduce clutter" />
...
<ThemedImage
  ...
  light={iOSAssetLight}
  dark={iOSAssetDark}
  alt="Xcode showing asset catalog"
/>
...
[Full code][multi-file] &bull; [Changes only][multi-file-pr]
...
[Full code][single-token] &bull; [Changes only][single-token-pr]
...
<ThemedImage
  style={{maxWidth: '15rem', float: 'left', marginRight: 'var(--size-padding-base)', marginBottom: 'var(--size-padding-base)'}}
  light={HighContrastLight}
  dark={HighContrastDark}
  alt="iOS accessibility settings showing high contrast"
/>
