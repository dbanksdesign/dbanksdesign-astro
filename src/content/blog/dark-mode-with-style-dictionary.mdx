...
import preview from '../../img/dark-mode/preview.mp4';
import ASProjectDark from '../../img/dark-mode/as-project-dark.png'
import ASProjectLight from '../../img/dark-mode/as-project-light.png'
...
<ThemedImage light={ASProjectLight} dark={ASProjectDark} alt="Testing" />
